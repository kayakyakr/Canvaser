...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGES", "lib/win32/api.so", "MANIFEST", "Rakefile", "README", "test/test_win32_api.rb", "test/test_win32_api_callback.rb", "test/test_win32_api_function.rb", "win32-api.gemspec", "ext/win32/api.c"]
