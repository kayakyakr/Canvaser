...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGES", "examples/test_create.rb", "examples/test_fork_wait.rb", "examples/test_fork_waitpid.rb", "examples/test_kill.rb", "lib/win32/process.rb", "MANIFEST", "Rakefile", "README", "test/test_win32_process.rb", "win32-process.gemspec"]
